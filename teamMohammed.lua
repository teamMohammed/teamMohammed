...
if text == (Redis:get(TheteamMohammed.."teamMohammed:Name:Bot") or "محمد") then
local NamesBot = (Redis:get(TheteamMohammed.."teamMohammed:Name:Bot") or "محمد")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n▢ ︙أهلآ بك في بوت '..(Redis:get(TheteamMohammed.."teamMohammed:Name:Bot") or "محمد")..
